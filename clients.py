...
# ... existing imports ...
from typing import List, Optional  # add
...
class KalshiWebSocketClient(KalshiBaseClient):
    def __init__(
        ...
        private_key: rsa.RSAPrivateKey,
        environment: Environment = Environment.DEMO,
        market_tickers: Optional[List[str]] = None,   # add
    ):
        super().__init__(key_id, private_key, environment)
        self.ws = None
        self.url_suffix = "/trade-api/ws/v2"
        self.message_id = 1
        self.market_tickers = market_tickers or []     # add
    ...
    async def on_open(self):
        ...
        await self.subscribe_to_tickers(self.market_tickers)  # pass list

    async def subscribe_to_tickers(self, tickers: Optional[List[str]] = None):
        params = {"channels": ['ticker', 'orderbook_delta', 'trade'],
